...
const setsPayload = {
  ...
  equipos: {
    equipo1: { nombre: 'Equipo 1', jugadores: [{ nombre_display: 'Ana' }] },
    equipo2: { nombre: 'Equipo 2', jugadores: [{ nombre_display: 'Bruno' }] },
  },
  resultado: {
    formato: 'sets',
    ganador: 'equipo1',
...
describe('matchSummaryDeterministicAnalysis', () => {
  ...
  it('analiza partido 2-1 con tercer set decisivo y reacción del perdedor', () => {
    ...
    assert.equal(analisis.frases_sugeridas.definido_en_tercer_set, true);
