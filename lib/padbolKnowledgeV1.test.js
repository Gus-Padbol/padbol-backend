...
describe('padbolKnowledgeV1', () => {
  it('expone versión 1.1.1 y secciones esperadas', () => {
    assert.equal(PADBOL_KNOWLEDGE_VERSION, '1.1.1');
...
describe('chiviContext', () => {
  it('integra knowledge v1.1 en el system prompt', () => {
    assert.match(CHIVI_SYSTEM_PROMPT, /BASE DE CONOCIMIENTO PADBOL \(v1\.1\.1\)/);
