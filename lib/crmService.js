...
export function createCrmService({ repository, now = () => new Date() } = {}) {
  ...
  return {
    ...
    async createConversation({ contactId, sourceChannel, sourceRef, attemptId, identityUsed, bodyPreview } = {}) {
    ...
    async ingestInbound({ source, sourceId, channel, email, phone, nombre, identityUsed } = {}) {
